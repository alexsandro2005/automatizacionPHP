...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "formreg")) {
    ...
    if ($register_validation) {
        ...
        $register_user = $connection->prepare("INSERT INTO usuario(document,nombre_completo,telefono,correo,tipo_usuario,estado,fecha_registro) VALUES('$document_user','$name_user','$telephone','$email',2,1,NOW())");
            ...
            <form method="POST" name="formreg" action="" autocomplete="off">
                ...
                <div class="form-group">
                    <div class="formulario__grupo__input">
                        ...
                        <input type="hidden" value="2" name="tipo_usuario">
                    </div>
                </div>
