...
$user_report = $connection->prepare("SELECT * FROM usuario WHERE tipo_usuario = 2");
$user_report->execute();
...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="mt-3 col-xs-12 ml-2">
            <a href="usuario.php" class="btn btn-block btn-info">Registrar Cliente</a>
        </div>
                ...
                <div class="table-responsive">
                    ...
                    <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            <?php
                            $comando = $connection->prepare("SELECT * FROM usuario WHERE tipo_usuario = 2");
                            $comando->execute();
